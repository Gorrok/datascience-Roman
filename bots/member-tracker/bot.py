...
# Импорт моделей и менеджера Google Sheets
...
class MemberTrackerBot:
    ...
    async def start_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        await update.message.reply_text(
            ...
            f"Мониторю каналы: {', '.join(self.monitored_channels)}\n\n"
            "Доступные команды:\n"
...
• MONITORED_CHANNELS - список каналов через запятую
• DATABASE_URL - URL базы данных
    ...
    async def run(self):
        ...
        try:
            ...
            # Обработчик обновлений статуса участников
