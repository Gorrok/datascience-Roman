-- Финальный запрос со ВСЕМИ менеджерами (без LIMIT 5)
SELECT
    -- Totals
    (SELECT SUM(cnt) FROM (
    ...
    -- Top managers data (ВСЕ менеджеры, без LIMIT)
    'first_meetings' as section,
    m1.Ima_otvetstvennogo,
    m1.cnt as count_value,
...
SELECT
    NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
    'appointed_meetings' as section,
    m3.Ima_otvetstvennogo,
    m3.cnt,
    NULL
FROM (
    SELECT Ima_otvetstvennogo, COUNT(*) as cnt
...
SELECT
    NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
    'bookings' as section,
    m4.Ima_otvetstvennogo,
    m4.total_cnt,
    CONCAT('П:', m4.paid_cnt, ', Б:', m4.free_cnt)
FROM (
...
SELECT
    NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
    'qualified_leads' as section,
    m6.Ima_otvetstvennogo,
    m6.cnt,
    NULL
FROM (
    SELECT Ima_otvetstvennogo, COUNT(*) as cnt
...
SELECT
    NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
    'taken_leads' as section,
    m7.Ima_otvetstvennogo,
    m7.cnt,
    NULL
FROM (
    SELECT Ima_otvetstvennogo, COUNT(*) as cnt
